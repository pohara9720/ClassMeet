  ...
  render() {
      ...
      return (
          <View style={styles.container}>
              <Header
                  centerComponent={{ text: `${this.props.navigation.state.params.user.name}`, style: { color: '#cc0000',fontSize:30 } }}
                  rightComponent={{ icon: 'more-horiz', color: '#cc0000',onPress: () => this.props.navigation.dispatch(backAction)}}
              ...
              <ScrollView>
                  ...
                  <View style={{flex:1,padding:10}}>
                      <View style={{display:'flex',flexDirection:'row'}}>
                          ...
                          <View style={{flexGrow:1}}>
                              <TouchableOpacity onPress={() => navigate('ImageView')}><Image resizeMode='cover' style={{height:150,width:150,borderRadius:10}} source={{uri:this.props.navigation.state.params.user.image}}/></TouchableOpacity>
                          </View>
                          <View style={{flexGrow:1}}>
                              <View style={{flexDirection:'row',display:'flex',alignItems:'center',flexGrow:1}}><Icon type='ionicon' name='logo-apple' color= '#cc0000'/><Text style={styles.ratings}>{this.props.navigation.state.params.user.rating}</Text></View>
                              <View style={{flexDirection:'row',display:'flex',alignItems:'center',flexGrow:1}}><Icon type='ionicon' name='ios-clipboard' color= '#cc0000' /><Text style={styles.ratings}>{this.props.navigation.state.params.user.reviews}</Text></View>
                          </View>
                      </View>
                          ...
                          <List>
                              {
                                  this.state.list.map((item, i) => (
                                      <ListItem
                                          ...
                                          subtitle={`${item.mutual} Mutual friends with ${this.props.navigation.state.params.user.name}`}
